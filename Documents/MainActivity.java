...
//
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            if (Constant.allMediaList.get(position).getName().contains(".docx"))
            {
                Glide.with(mContext).load(R.drawable.docx_image).thumbnail(0.1f).into(((RecyclerViewAdapter.FileLayoutHolder) holder).thumbnail);
            }
            else if (Constant.allMediaList.get(position).getName().contains(".apk"))
            {
                Glide.with(mContext).load(R.drawable.apk_image).thumbnail(0.1f).into(((RecyclerViewAdapter.FileLayoutHolder) holder).thumbnail);
            }
            else if (Constant.allMediaList.get(position).getName().contains(".zip"))
            {
                Glide.with(mContext).load(R.drawable.zip_image).thumbnail(0.1f).into(((RecyclerViewAdapter.FileLayoutHolder) holder).thumbnail);
            }
            else if (Constant.allMediaList.get(position).getName().contains(".ppt"))
            {
                Glide.with(mContext).load(R.drawable.ppt_image).thumbnail(0.1f).into(((RecyclerViewAdapter.FileLayoutHolder) holder).thumbnail);
            }


            ((FileLayoutHolder) holder).docsize_size.setText(Constant.allMediaList.get(position).getName());

            ((FileLayoutHolder) holder).thumbnail.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            ((FileLayoutHolder) holder).filled_send.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ((FileLayoutHolder) holder).check_box.setVisibility(View.VISIBLE);
                    ...
                    if (null != activeNetWork) {
                        ...
                        Toast.makeText(MainActivity.this, "you are not connected with Internet Connection", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            ...
            ((FileLayoutHolder) holder).check_box.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(MainActivity.this, "Already sended....!", Toast.LENGTH_SHORT).show();
                }
            });
        }
    ...
    private void addDocx(String message, String sender, String receiver, String messageId, String bio, String type, String time, String date, String lastSendMessage, String preMessage, String isseen, String imageurl,Uri camuri){
        ...
        final StorageReference filePath = storageReference.child(bio);
