                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ActivityCompat.requestPermissions(AllDocumentsActivity.this,
                ...
                public void onClick(View view) {
                    ...
                    if (null != activeNetWork) {
                        if (activeNetWork.getType() == ConnectivityManager.TYPE_WIFI) {
                            ...
                            addPdfs(uri.toString(), fuser.getUid(), userid, messageID, "kt5rg2/r78I081y/kXkhw==\n", "pdf", saveCurrentTime, saveCurrentDate, "hello", "kya", "panding", uri.toString());
                        } else if (activeNetWork.getType() == ConnectivityManager.TYPE_MOBILE) {

                            addPdfs(uri.toString(), fuser.getUid(), userid, messageID, "kt5rg2/r78I081y/kXkhw==\n", "pdf", saveCurrentTime, saveCurrentDate, "hello", "kya", "panding", uri.toString());
                        }
                    } else {
                        addItemInRealmNoInternet(uri.toString(), fuser.getUid(), userid, messageID, "kt5rg2/r78I081y/kXkhw==\n", "pdf", saveCurrentTime, saveCurrentDate, "hello", "kya", "never", uri.toString());

                        Toast.makeText(AllDocumentsActivity.this, "you are not connected with Internet Connection", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
                ...
                addOnCompleteListener(new OnCompleteListener<Uri>() {
                    ...
                    public void onComplete (@NonNull Task < Uri > task) {
                        if (task.isSuccessful()) {
                            ...
                            messageTextBody.put("name", "rj 31");
                            ...
                            RootRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(AllDocumentsActivity.this, "Error", Toast.LENGTH_SHORT).show();
                                    }
                                ...
                                public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                    if (response.code() == 200) {
                                        if (response.body().success != 1) {
                                            Toast.makeText(AllDocumentsActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                }
