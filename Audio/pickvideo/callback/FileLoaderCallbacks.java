...
import com.some.notes.Audio.pickvideo.loader.AudioLoader;
import com.some.notes.Audio.pickvideo.loader.FileLoader;
import com.some.notes.Audio.pickvideo.loader.ImageLoader;
import com.some.notes.Audio.pickvideo.loader.PdfLoader;
import com.some.notes.Audio.pickvideo.loader.VideoLoader;
...
import static android.provider.Contacts.Extensions.CONTENT_TYPE;
...
public class FileLoaderCallbacks implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        switch (mType) {
            ...
            case TYPE_PDF:
                mLoader = new PdfLoader(context.get());
                break;
        }
    ...
    private void onPdfResult(Cursor data) {
        List<Directory<PdfFile>> directories = new ArrayList<>();
        ...
        while (data.moveToNext()) {
            ...
            //Create a Directory
            Directory<PdfFile> directory = new Directory<>();
