    ...
    private void initView() {
        ...
        rl_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(VideoPickActivity.this, MessageActivity.class);
    ...
    public class VideoPickAdapter extends BaseAdapter<VideoFile, VideoPickAdapter.VideoPickViewHolder> {
        ...
        public void onBindViewHolder(final VideoPickAdapter.VideoPickViewHolder holder, int position) {
            ...
            holder.send_image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (null!=activeNetWork){
                        ...
                        Toast.makeText(VideoPickActivity.this, "you are not connected with Internet Connection", Toast.LENGTH_SHORT).show();
                    }
            ...
            holder.check_box_true.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(VideoPickActivity.this, "Already sended", Toast.LENGTH_SHORT).show();
                }
            });
                            ...
                            RootRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(VideoPickActivity.this, "Error", Toast.LENGTH_SHORT).show();
                                    }
                                ...
                                public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                    if (response.code() == 200) {
                                        if (response.body().success != 1) {
                                            Toast.makeText(VideoPickActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                }
