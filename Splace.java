...
public class Splace extends AppCompatActivity {
    ...
    private SqlChatsActivity.PersonUserChatsAdapter adapter;
    private SqlChatsActivity.PersonChatsUserDBHelper dbHelper;
     ProgressBar splashProgress;
    int SPLASH_TIME = 1500; //This is 1.5 seconds
    Window window;
    private RecyclerView emailRecyclerview,sqlchats_emails_users;
    private LinearLayoutManager emailsLayoutManager;
    private PersonEmailDBHelper emailHelper;
    private Splace.PersonEmailAdapter emailAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser == null) {
            Intent intent = new Intent(Splace.this, LoginActivityInstagram.class);
        ...
        else
        {
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent mySuperIntent = new Intent(Splace.this, SqlChatsActivity.class);
    ...
    private void populaterEmailsecyclerView(String filter){
        ...
        emailAdapter = new Splace.PersonEmailAdapter(emailHelper.peopleList(filter), this, emailRecyclerview);
