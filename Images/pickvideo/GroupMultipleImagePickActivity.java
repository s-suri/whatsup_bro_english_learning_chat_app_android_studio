...
public class GroupMultipleImagePickActivity extends BaseActivity {
    ...
    Realm realm;
    public static String userid, adminId,str_name;
        ...
        dbreference.child(fuser.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(GroupMultipleImagePickActivity.this, "", Toast.LENGTH_SHORT).show();
            }
    ...
    private void initView() {
        ...
        rl_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GroupMultipleImagePickActivity.this, MessageActivity.class);
        ...
        switch (requestCode) {
            case StaticFinalValues.REQUEST_CODE_TAKE_VIDEO:
                if (resultCode == RESULT_OK) {
                    ...
                    Toast.makeText(GroupMultipleImagePickActivity.this, contentUri.toString(), Toast.LENGTH_SHORT).show();
        ...
        public void onBindViewHolder(final VideoPickViewHolder holder, int position) {
            ...
            holder.send_image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    new ImageCompressionAsyncTask(GroupMultipleImagePickActivity.this).execute("file://" + file.getPath(),
            ...
            holder.check_box_true.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(GroupMultipleImagePickActivity.this, "Already sended", Toast.LENGTH_SHORT).show();
                }
            });
                    ...
                    if (task.isSuccessful()) {
                        ...
                        RootRef.child(saveCurrentDate1 + saveCurrentTime1).updateChildren(messageTextBody).addOnCompleteListener(new OnCompleteListener() {
                            ...
                            public void onComplete(@NonNull Task task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(GroupMultipleImagePickActivity.this, "he succes", Toast.LENGTH_SHORT).show();
                                    ...
                                    Toast.makeText(GroupMultipleImagePickActivity.this, "Error", Toast.LENGTH_SHORT).show();
                                }
                                ...
                                public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                    if (response.code() == 200) {
                                        if (response.body().success != 1) {
                                            Toast.makeText(GroupMultipleImagePickActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent2 = new Intent(GroupMultipleImagePickActivity.this, MassageActivityInstagram.class);
