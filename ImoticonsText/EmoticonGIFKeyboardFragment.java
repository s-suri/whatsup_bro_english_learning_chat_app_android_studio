...
package com.some.notes.ImoticonsText;
...
import com.some.notes.ImoticonsText.emoticons.EmoticonProvider;
import com.some.notes.ImoticonsText.emoticons.EmoticonSelectListener;
import com.some.notes.ImoticonsText.gifs.GifProviderProtocol;
import com.some.notes.ImoticonsText.gifs.GifSelectListener;
import com.some.notes.ImoticonsText.internal.emoticon.EmoticonFragment;
import com.some.notes.ImoticonsText.internal.emoticon.EmoticonSearchFragment;
import com.some.notes.ImoticonsText.internal.gif.GifFragment;
import com.some.notes.ImoticonsText.internal.gif.GifSearchFragment;
...
public final class EmoticonGIFKeyboardFragment extends Fragment implements FragmentManager.OnBackStackChangedListener {
    ...
    public synchronized void emoticonNull(Context context) {
        Toast.makeText(context, "open", Toast.LENGTH_SHORT).show();
    ...
    public void toggle(Context context) {
        if (isOpen()) close(context);
        else open(context);
    }

    public void emoticonClose(Context context) {
//        if (isOpen()) close(context);
//        else emoticonNull(context);
